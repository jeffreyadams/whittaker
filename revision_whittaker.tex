...
\end{itemize}
The theorem follows immediately from these two observations, and from the following basic fact on group actions, whose proof is left to the reader.
...
\begin{center} \textcolor{red}{TODO : indicate in which sections of the paper we prove each of the statements in (i)-(ii) about the actions of $Q(G)$. }\end{center} 


\begin{remark} \textcolor{red}{\textup{TODO : add a remark about the case of fundamental series packets, in case there is no DS. }}\end{remark} 


\begin{remark} \textcolor{red}{\textup{TODO : say what this looks like when $G$ is adjoint, or simply connected, and add a remark on the general case.}  }\end{remark} 
