...
Suppose $\pi$ is an irreducible $(\g,KL)$-module.
...
the Hilbert space globalization of $\pi$, and similarly $\Wh(\pi)$. 
In the other direction if $\pi$ is an irreducible Hilbert space representation of $G(\R)$ we define $\AV(\pi)$ to be the associated variety 
...
Similarly $Q_\theta(G)$ is a group of automorphisms of $(\g,K)$, and acts on $(\g,K)$-modules. 
...
This action preserves $L$-packets by 
by~\cite[Lemma 6.18]{Contragredient}.
