...
Part~(c) follows from~\cite[Lemma B]{rossmann_limit_orbits}. Let us briefly explain how to go from there to  assertion~(c), using standard facts on the asymptotic cone recalled below in Section~\ref{sec:asymp_cone} below.
