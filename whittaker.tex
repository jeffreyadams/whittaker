...
. In general the orbits $\mathcal{O}_\pi$ and $G(\R) \cdot H_\theta$ are disjoint. Nevertheless $H_{\lambda}$ and $H_\theta=[E_\theta, F_\theta]$ are in the same Weyl chamber. Therefore the result follows from:  
