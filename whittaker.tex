...
Define\footnote{AA 2024-VI-14: should perhaps think about consistency in notation, and decide if we fix a large chamber from the start and take the HC parameter to live there, or add a few words about independence of choices...}
...
We know that  $\AV(\pi)=K \cdot F_\pi$, so the image of $\AV(\pi)$ by the Sekiguchi correspondence is 
