...
\item Comment 5 spotted an important omission in the original version: you are entirely right that we forgot to explain why the action of $Q(G)$ on the generic elements of an $L$-packet is (simply) transitive. This is now done in a new Section~1.4.2, which also describes discrete series $L$-packets. The proof of the missing step uses an interpretation of $Q(G)$ as a quotient of the Weyl group, and the corresponding action on large Weyl chambers; the compatibility with the other incarnations of $Q(G)$, as $Q_\sigma$ and $Q_\theta$, is explained in a new Lemma 2.7, and at the end of Section~2.3.1. 

The report also mentioned that it would be helpful to add a roadmap for the proof of the main statements leading up to the proof of Theorem~2.1: we have added this and tried to make other changes to clarify the organization (adding comments, numbering sections, and inserting a new section 2.3.2 on Whittaker data).
...
\item Comment 10 asked about the case of quasi-split groups with no discrete series, and whether it is possible to say something about fundamental series $L$-packets along the lines of the paper. Since generic fundamental series representations are irreducibly induced from generic discrete series of Levi subgroups,  there should indeed be a close relation ; the Adams-Barbasch-Vogan book has a discussion of the relationship between the Whittaker data for the inducing generic discrete series and those for the induced representation, but this does not immediately yield a precise and general statement. We have added Remark 2.4 to explain this and give a reference. 
