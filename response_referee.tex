...
\item Comment 10 asked about the case of quasi-split groups with no discrete series, and whether it is possible to say something about fundamental series $L$-packets along the lines of the paper. Since generic fundamental series representations are irreducibly induced from generic discrete series of Levi subgroups,  there should indeed be a close relation ; the Adams-Barbasch-Vogan book has a discussion of the relationship between the Whittaker models for the inducing generic discrete series and those for the induced representation, but this does not immediately yield a precise and general statement. We have added Remark 2.4 to explain this and give a reference. 
...
\item Finally, comment 7 asked whether there is something general
  ...
  can be two cases, as in the $SU(n,n-1)$ case; but we don't know of any nice
  statement that holds in general.
\end{itemize}
