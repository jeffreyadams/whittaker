...
The report also mentioned that it would be helpful to say more explicitly where the main statements leading up to the proof of Theorem~2.1 are proved: we have added this and tried to make other changes to clarify the organization (adding comments, numbering sections, and also inserting a new section 2.3.2 concerning the action Whittaker data).
